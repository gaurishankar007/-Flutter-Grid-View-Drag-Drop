import 'edit_section_name_dialog.dart';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (index != 0)
                    GestureDetector(
                      onTap: () => BlocProvider.of<DragDropCubit>(context)..deleteSection(index),
                      child: Container(
                        padding: const EdgeInsets.all(5),
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
              ...
              child: Stack(
                children: [
                  GridView.count(
                    ...
                    children: List.generate(section.mainAxisCount * crossAxisCount, (index) {
                      return Container(
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border.all(
                  ...
                  Stack(
                    children: List.generate(section.wheels.length, (wheelIndex) {
